...
NanKe 致力于打造一个现代化的 AI 角色扮演与文本创作平台。本项目并非对已有酒馆项目的简单复刻，而是从零开始的重新思考：抛弃沉重的历史包袱，使用现代化的技术栈与架构，将真正重要的“角色对话”与“设定管理”做到极致。
...
- 📦 **资产兼容，无缝衔接：** 完美兼容社区中有价值的旧资产（如现有的角色卡、设定集），但不继承不必要的历史数据结构。
